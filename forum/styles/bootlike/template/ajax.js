...
phpbb.addAjaxCallback('mark_forums_read', function(res) {
	...
	$('div.table-bordered').find('div[class*="forum_unread"]').each(function() {
		var $this = $(this);
	...
	// Mark subforums read
	$('i[class*="fa-comment"]').removeClass('fa-comment').addClass('fa-comment-o');
...
phpbb.addAjaxCallback('mark_topics_read', function(res, updateTopicLinks) {
	...
	$('div.table-bordered').find(unreadClassSelectors).each(function() {
		var $this = $(this);
