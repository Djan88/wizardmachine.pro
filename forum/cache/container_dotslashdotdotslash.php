...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'shredder.pai.listener' => 'getShredder_Pai_ListenerService',
    ...
    {
        $this->services['avatar.driver.upload'] = $instance = new \phpbb\avatar\driver\upload($this->get('config'), './../', 'php', $this->get('path_helper'), $this->get('mimetype.guesser'), $this->get('cache.driver'));
    ...
    {
        $this->services['cron.task.core.tidy_search'] = $instance = new \phpbb\cron\task\core\tidy_search('./../', 'php', $this->get('auth'), $this->get('config'), $this->get('dbal.conn'), $this->get('user'));
    ...
    protected function getDbal_Conn_DriverService()
    {
        ...
        $instance->sql_connect('localhost', 'chikurov_fuser', '6o8FyNnWiWReGnL', 'chikurov_fm', '', false, false);
    ...
    protected function getDispatcherService()
    {
        ...
        $instance->addSubscriberService('shredder.pai.listener', 'shredder\\pai\\event\\listener');
    ...
    /**
     * Gets the 'shredder.pai.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \shredder\pai\event\listener A shredder\pai\event\listener instance.
     */
    protected function getShredder_Pai_ListenerService()
    {
        return $this->services['shredder.pai.listener'] = new \shredder\pai\event\listener($this->get('config'), $this->get('template'));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'dbal.dbuser' => 'chikurov_fuser',
            'dbal.dbpasswd' => '6o8FyNnWiWReGnL',
            'dbal.dbname' => 'chikurov_fm',
            'dbal.dbport' => '',
            'dbal.new_link' => false,
        );
    }
